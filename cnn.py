...
def get_glove_vectors(vocab):
    ...
    glove_vectors = {}
    found = 0
    with open(GLOVE_FILE, encoding="utf8") as glove_file:
...
if __name__ == '__main__':
    ...
    if train:
        ...
        filepath = (r"C:\Users\win10\Desktop\twitter-sentiment-analysis-master\models\model.h5")
        ...
        model = load_model('test-processed.csv')
        print (model.summary())
